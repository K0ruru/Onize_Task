    ...
    <div class="dashboard-content" :style="{ marginLeft: isCollapsed ? '80px' : '247px' }">
      ...
      <div class="task-container">
        <div class="task-card-container">
          <h2>Not Started</h2>
          <draggable :list="notStartedTasks" group="tasks" item-key="id" @end="onDragEnd">
            <template #item="{ element }">
              <div :data-task-id="element.id" data-status="not started" class="task-card" draggable="true">
                <div class="task-item">
        ...
        <div class="task-card-container">
          <h2>In Progress</h2>
          <draggable :list="inProgressTasks" group="tasks" @end="onDragEnd" item-key="id">
            <template #item="{ element }">
              <div :data-task-id="element.id" data-status="in progress" class="task-card" draggable="true">
                <div class="task-item">
                  <div class="task-content">
                    <div class="task-title">{{ element.title }}</div>
                    <div class="task-deadline">
        ...
        <div class="task-card-container">
          <h2>Done</h2>
          <draggable :list="doneTasks" group="tasks" @end="onDragEnd" item-key="id">
            <template #item="{ element }">
              <div :data-task-id="element.id" data-status="completed" class="task-card" draggable="true">
                <div class="task-content">
                  <div class="task-title">{{ element.title }}</div>
                  <div class="task-deadline">
                    <i class="pi pi-circle-fill green"></i>
